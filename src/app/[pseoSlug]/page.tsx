...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: context.title,
    description: `Use the best ${context.h1} online for free. ${context.tool.description}`,
    alternates: {
      canonical: `https://takethetools.com/${pseoSlug}`,
    },
    openGraph: {
      title: context.title,
      description: context.tool.description,
      url: `https://takethetools.com/tools/${context.tool.slug}`,
