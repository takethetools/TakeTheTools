...
const TOOL_COMPONENTS: Record<string, React.ComponentType<any>> = {
  ...
  "rotate-pdf": RotatePDFTool, // Alias
  ...
  "js-formatter": () => <CodeFormatterTool language="javascript" />, // Alias
  ...
  "date-difference": DateDifferenceTool, // Alias
  "aes-encryption-decryption": () => <AESTool mode="encrypt" />,
  "aes-encrypt": () => <AESTool mode="encrypt" />, // Alias
  "aes-decrypt": () => <AESTool mode="decrypt" />, // Explicitly mapping decrypt
  "password-strength-checker": PasswordStrengthTool,
  "base32-encoder-decoder": () => <Base32Tool mode="encode" />,
  "base32-encoder": () => <Base32Tool mode="encode" />, // Alias
  "base32-decoder": () => <Base32Tool mode="decode" />, // Alias
  ...
  "fraction-to-decimal-converter": () => <MathTool mode="fraction" />,
  "decimal-to-fraction-converter": () => <MathTool mode="decimal" />,
  ...
  "keyword-density-checker-tool": () => <MiscellaneousTools mode="keyword-density" />,
  "keyword-density-checker": () => <MiscellaneousTools mode="keyword-density" />,
  "redirect-checker-tool": () => <NetworkLookupTool mode="redirect" />,
  "redirect-checker": () => <NetworkLookupTool mode="redirect" />,
  "angle-converter-tool": () => <UnitConverterTool initialCategory="angle" />,
  "area-converter-tool": () => <UnitConverterTool initialCategory="area" />,
  "byte-converter-tool": () => <UnitConverterTool initialCategory="digital" />,
  "energy-converter-tool": () => <UnitConverterTool initialCategory="energy" />,
  "force-converter-tool": () => <UnitConverterTool initialCategory="force" />,
  "fuel-consumption-converter-tool": () => <UnitConverterTool initialCategory="fuel" />,
  "length-converter-tool": () => <UnitConverterTool initialCategory="length" />,
  "power-converter-tool": () => <UnitConverterTool initialCategory="power" />,
  "pressure-converter-tool": () => <UnitConverterTool initialCategory="pressure" />,
  "speed-converter-tool": () => <UnitConverterTool initialCategory="speed" />,
  "temperature-converter-tool": () => <UnitConverterTool initialCategory="temperature" />,
  "time-converter-tool": () => <UnitConverterTool initialCategory="time" />,
  "torque-converter-tool": () => <UnitConverterTool initialCategory="torque" />,
  "volume-converter-tool": () => <UnitConverterTool initialCategory="volume" />,
  "weight-converter-tool": () => <UnitConverterTool initialCategory="weight" />,
  "data-transfer-rate-converter-tool": () => <UnitConverterTool initialCategory="digital" />,
  "digital-storage-converter-tool": () => <UnitConverterTool initialCategory="digital" />,
  "binary-to-hex-tool": () => <NumberSystemConverterTool />,
  "hex-to-binary-tool": () => <NumberSystemConverterTool />,
  "binary-to-octal-tool": () => <NumberSystemConverterTool />,
  "octal-to-binary-tool": () => <NumberSystemConverterTool />,
  "hex-to-text-tool": () => <NumberSystemConverterTool />,
  "text-to-hex-tool": () => <NumberSystemConverterTool />,
  "binary-to-decimal-tool": () => <NumberSystemConverterTool />,
  "decimal-to-binary-tool": () => <NumberSystemConverterTool />,
  "html-entities-encode-tool": HtmlEntityConverterTool,
  "html-entities-decode-tool": HtmlEntityConverterTool,
  "markdown-to-html-tool": MarkdownPreviewerTool, // Previewer can handle MD->HTML
  "html-to-markdown-tool": MarkdownPreviewerTool,
  "ascii-to-text-tool": () => <TextConverterTool mode="ascii-to-text" />,
  "text-to-ascii-tool": () => <TextConverterTool mode="text-to-ascii" />,
