      ...
      <section className="container mx-auto px-4 -mt-10">
        <div className="max-w-5xl mx-auto bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-100/50 p-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-4xl font-display font-bold text-slate-900 mb-1">200+</p>
              <p className="text-sm text-slate-500 font-medium">Free Tools</p>
            </div>
            <div>
              <p className="text-4xl font-display font-bold text-slate-900 mb-1">100%</p>
              <p className="text-sm text-slate-500 font-medium">Browser-Based</p>
            </div>
            <div>
              <p className="text-4xl font-display font-bold text-slate-900 mb-1">0</p>
              <p className="text-sm text-slate-500 font-medium">Files Stored</p>
            </div>
            <div>
              <p className="text-4xl font-display font-bold text-slate-900 mb-1">8</p>
...
<<<<<<< HEAD
              },
              {
                ...
                a: "All modern browsers are supported — Chrome, Firefox, Safari, and Edge. Our tools are fully responsive and work on desktop, tablet, and mobile devices."
              },
              {
