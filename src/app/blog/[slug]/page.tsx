...
import { ChevronLeft, Calendar, User, Tag, ArrowRight, List, Zap } from "lucide-react";
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            {post.toolSlug && (
              <Link
                ...
                className="block bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all group border border-slate-700 hover:border-primary-500/50"
              >
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-8 h-8 bg-primary-600 rounded-xl flex items-center justify-center">
                    <Zap className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-xs font-bold uppercase tracking-widest text-primary-400">Free Tool</span>
                </div>
                <h3 className="font-bold text-base mb-2">{post.toolName || "Try the Tool"}</h3>
                <p className="text-slate-400 text-xs leading-relaxed mb-4">Use this tool free — no signup required.</p>
                <span className="inline-flex items-center gap-1 text-primary-400 text-sm font-bold group-hover:gap-2 transition-all">
