        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="w-full md:w-1/3 flex flex-col items-center gap-6">
            ...
            <input 
              ...
              className="w-full h-12 rounded-xl cursor-pointer bg-slate-50 p-1"
            />
            <input 
              type="text" 
              value={color}
              onChange={(e) => setColor(e.target.value)}
              className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-center font-mono font-bold text-slate-700"
            />
          </div>
