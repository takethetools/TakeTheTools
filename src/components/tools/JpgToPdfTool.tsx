          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {images.map((img) => (
                <div
                  key={img.id}
                  className="relative group aspect-square rounded-xl overflow-hidden border border-slate-100 bg-slate-50"
                >
                  <img
                    src={img.preview}
                    alt="Preview"
              ...
              >
                ...
                <span className="text-[10px] font-bold text-slate-400 group-hover:text-primary-600 uppercase">
                  Add More
                </span>
              </label>
            </div>
