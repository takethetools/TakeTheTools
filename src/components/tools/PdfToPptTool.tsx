...
import { PresentationIcon, ExternalLink, AlertCircle, RefreshCw } from "lucide-react";

export default function PdfToPptTool() {
  const [file, setFile] = useState<File | null>(null);
  const TOOLS = [
    { name: "ilovepdf.com — PDF to PPT", url: "https://www.ilovepdf.com/pdf_to_powerpoint", note: "Free, no sign-up for small files" },
    { name: "smallpdf.com — PDF to PPT", url: "https://smallpdf.com/pdf-to-ppt", note: "2 conversions/day free" },
    { name: "Adobe Acrobat Online", url: "https://www.adobe.com/acrobat/online/pdf-to-ppt.html", note: "Free with sign-in" },
  ];
  return (
      ...
      {!file ? (
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-6">
          ...
          <div className="p-4 bg-amber-50 border border-amber-100 rounded-2xl flex gap-3">
            ...
            <p className="text-sm text-amber-700">PDF-to-PowerPoint conversion needs a server-side engine to reconstruct slides. Use one of these trusted free services:</p>
          </div>
