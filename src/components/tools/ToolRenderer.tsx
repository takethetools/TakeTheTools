...
const TOOL_COMPONENTS: Record<string, React.ComponentType<any>> = {
    ...
    "json-to-typescript": () => <GenericMockTool name="JSON to TypeScript Interface" sourceType="JSON" targetType="TS" />,
    ...
    "csv-to-xml": () => <GenericMockTool name="CSV to XML" sourceType="CSV" targetType="XML" />,
    "xml-to-csv": () => <GenericMockTool name="XML to CSV" sourceType="XML" targetType="CSV" />,
    "markdown-to-pdf": () => <GenericMockTool name="Markdown to PDF" sourceType="MD" targetType="PDF" />,
    "excel-to-json": () => <GenericMockTool name="Excel to JSON" sourceType="XLSX" targetType="JSON" />,
    "word-to-markdown": () => <GenericMockTool name="Word to Markdown" sourceType="DOCX" targetType="MD" />,
