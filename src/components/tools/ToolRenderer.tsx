    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-slate-400">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold uppercase tracking-wider">100% Secure</span>
        </div>
        <div className="flex items-center gap-2">
          <Lock className="w-4 h-4 text-blue-500" />
          <span className="text-xs font-bold uppercase tracking-wider">No Server Upload</span>
        </div>
        <div className="flex items-center gap-2">
...
const WebPToPngTool = dynamic(
  () => import("@/components/tools/WebPToPngTool"),
...
const JwtDecoderTool = dynamic(
  () => import("@/components/tools/JwtDecoderTool"),
  { loading: ToolLoading, ssr: false },
);
const WordCounterTool = dynamic(
  () => import("@/components/tools/WordCounterTool"),
  { loading: ToolLoading, ssr: false },
);
...
const PasswordGeneratorTool = dynamic(
  () => import("@/components/tools/PasswordGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
...
const Mp4ToMp3Tool = dynamic(() => import("@/components/tools/Mp4ToMp3Tool"), {
  loading: ToolLoading,
  ssr: false,
});
const VideoConverterTool = dynamic(
  () => import("@/components/tools/VideoConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const CaseConverterTool = dynamic(
  () => import("@/components/tools/CaseConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const RegexTesterTool = dynamic(
  () => import("@/components/tools/RegexTesterTool"),
  { loading: ToolLoading, ssr: false },
);
...
const ImageCropperTool = dynamic(
  () => import("@/components/tools/ImageCropperTool"),
  { loading: ToolLoading, ssr: false },
);
...
const ImageToWebpTool = dynamic(
  () => import("@/components/tools/ImageToWebpTool"),
  { loading: ToolLoading, ssr: false },
);
const SqlFormatterTool = dynamic(
  () => import("@/components/tools/SqlFormatterTool"),
  { loading: ToolLoading, ssr: false },
);
const XmlFormatterTool = dynamic(
  () => import("@/components/tools/XmlFormatterTool"),
  { loading: ToolLoading, ssr: false },
);
const HtmlFormatterTool = dynamic(
  () => import("@/components/tools/HtmlFormatterTool"),
  { loading: ToolLoading, ssr: false },
);
const LoremIpsumGeneratorTool = dynamic(
  () => import("@/components/tools/LoremIpsumGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const DiffCheckerTool = dynamic(
  () => import("@/components/tools/DiffCheckerTool"),
  { loading: ToolLoading, ssr: false },
);
const NumberSystemConverterTool = dynamic(
  () => import("@/components/tools/NumberSystemConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const UnitConverterTool = dynamic(
  () => import("@/components/tools/UnitConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const ColorConverterTool = dynamic(
  () => import("@/components/tools/ColorConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const ComingSoonTool = dynamic(
  () => import("@/components/tools/ComingSoonTool"),
  { loading: ToolLoading, ssr: false },
);
const BulkImageConverterTool = dynamic(
  () => import("@/components/tools/BulkImageConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const ImageFilterTool = dynamic(
  () => import("@/components/tools/ImageFilterTool"),
  { loading: ToolLoading, ssr: false },
);
const RotatePDFTool = dynamic(
  () => import("@/components/tools/RotatePDFTool"),
  { loading: ToolLoading, ssr: false },
);
const DeletePDFPagesTool = dynamic(
  () => import("@/components/tools/DeletePDFPagesTool"),
  { loading: ToolLoading, ssr: false },
);
...
const PasswordProtectPDFTool = dynamic(
  () => import("@/components/tools/PasswordProtectPDFTool"),
  { loading: ToolLoading, ssr: false },
);
const WatermarkPDFTool = dynamic(
  () => import("@/components/tools/WatermarkPDFTool"),
  { loading: ToolLoading, ssr: false },
);
const CodeFormatterTool = dynamic(
  () => import("@/components/tools/CodeFormatterTool"),
  { loading: ToolLoading, ssr: false },
);
...
const URLConverterTool = dynamic(
  () => import("@/components/tools/URLConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const CrontabGeneratorTool = dynamic(
  () => import("@/components/tools/CrontabGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const MarkdownPreviewerTool = dynamic(
  () => import("@/components/tools/MarkdownPreviewerTool"),
  { loading: ToolLoading, ssr: false },
);
const JsonCsvConverter = dynamic(
  () => import("@/components/tools/JsonCsvConverter"),
  { loading: ToolLoading, ssr: false },
);
const CurlToFetchTool = dynamic(
  () => import("@/components/tools/CurlToFetchTool"),
  { loading: ToolLoading, ssr: false },
);
...
const TextProcessingTool = dynamic(
  () => import("@/components/tools/TextProcessingTool"),
  { loading: ToolLoading, ssr: false },
);
const TextConverterTool = dynamic(
  () => import("@/components/tools/TextConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const SentimentAnalysisTool = dynamic(
  () => import("@/components/tools/SentimentAnalysisTool"),
  { loading: ToolLoading, ssr: false },
);
const FindAndReplaceTool = dynamic(
  () => import("@/components/tools/FindAndReplaceTool"),
  { loading: ToolLoading, ssr: false },
);
const WordFrequencyTool = dynamic(
  () => import("@/components/tools/WordFrequencyTool"),
  { loading: ToolLoading, ssr: false },
);
const InstaBioFontGeneratorTool = dynamic(
  () => import("@/components/tools/InstaBioFontGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const SitemapGeneratorTool = dynamic(
  () => import("@/components/tools/SitemapGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const ASCIIArtTool = dynamic(() => import("@/components/tools/ASCIIArtTool"), {
  loading: ToolLoading,
  ssr: false,
});
const TwitterCharacterCounterTool = dynamic(
  () => import("@/components/tools/TwitterCharacterCounterTool"),
  { loading: ToolLoading, ssr: false },
);
const UTMBuilderTool = dynamic(
  () => import("@/components/tools/UTMBuilderTool"),
  { loading: ToolLoading, ssr: false },
);
const OGPreviewerTool = dynamic(
  () => import("@/components/tools/OGPreviewerTool"),
  { loading: ToolLoading, ssr: false },
);
...
const AverageCalculatorTool = dynamic(
  () => import("@/components/tools/AverageCalculatorTool"),
  { loading: ToolLoading, ssr: false },
);
const BMICalculatorTool = dynamic(
  () => import("@/components/tools/BMICalculatorTool"),
  { loading: ToolLoading, ssr: false },
);
...
const LoanCalculatorTool = dynamic(
  () => import("@/components/tools/LoanCalculatorTool"),
  { loading: ToolLoading, ssr: false },
);
const RandomNumberGeneratorTool = dynamic(
  () => import("@/components/tools/RandomNumberGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const DateDifferenceTool = dynamic(
  () => import("@/components/tools/DateDifferenceTool"),
  { loading: ToolLoading, ssr: false },
);
const AESTool = dynamic(() => import("@/components/tools/AESTool"), {
  loading: ToolLoading,
  ssr: false,
});
const PasswordStrengthTool = dynamic(
  () => import("@/components/tools/PasswordStrengthTool"),
  { loading: ToolLoading, ssr: false },
);
const Base32Tool = dynamic(() => import("@/components/tools/Base32Tool"), {
  loading: ToolLoading,
  ssr: false,
});
...
const UuidGeneratorTool = dynamic(
  () => import("@/components/tools/UuidGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
...
const HtmlEntityConverterTool = dynamic(
  () => import("@/components/tools/HtmlEntityConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const HexToDecimalTool = dynamic(
  () => import("@/components/tools/HexToDecimalTool"),
  { loading: ToolLoading, ssr: false },
);
...
const JsonYamlConverter = dynamic(
  () => import("@/components/tools/JsonYamlConverter"),
  { loading: ToolLoading, ssr: false },
);
const BarcodeGeneratorTool = dynamic(
  () => import("@/components/tools/BarcodeGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const TextToSpeechTool = dynamic(
  () => import("@/components/tools/TextToSpeechTool"),
  { loading: ToolLoading, ssr: false },
);
const ImageColorPickerTool = dynamic(
  () => import("@/components/tools/ImageColorPickerTool"),
  { loading: ToolLoading, ssr: false },
);
const SocialMediaResizerTool = dynamic(
  () => import("@/components/tools/SocialMediaResizerTool"),
  { loading: ToolLoading, ssr: false },
);
const MathTool = dynamic(() => import("@/components/tools/MathTool"), {
  loading: ToolLoading,
  ssr: false,
});
const CSSGeneratorTool = dynamic(
  () => import("@/components/tools/CSSGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const FinanceCalculatorTool = dynamic(
  () => import("@/components/tools/FinanceCalculatorTool"),
  { loading: ToolLoading, ssr: false },
);
const MiscellaneousTools = dynamic(
  () => import("@/components/tools/MiscellaneousTools"),
  { loading: ToolLoading, ssr: false },
);
const SocialMediaTools = dynamic(
  () => import("@/components/tools/SocialMediaTools"),
  { loading: ToolLoading, ssr: false },
);
const DevGeneratorTool = dynamic(
  () => import("@/components/tools/DevGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const PDFAdvancedTool = dynamic(
  () => import("@/components/tools/PDFAdvancedTool"),
  { loading: ToolLoading, ssr: false },
);
const ImageAdvancedTool = dynamic(
  () => import("@/components/tools/ImageAdvancedTool"),
  { loading: ToolLoading, ssr: false },
);
const NetworkLookupTool = dynamic(
  () => import("@/components/tools/NetworkLookupTool"),
  { loading: ToolLoading, ssr: false },
);

const ScientificCalculatorTool = dynamic(
  () => import("@/components/tools/ScientificCalculatorTool"),
  { loading: ToolLoading, ssr: false },
);

const WhoisLookupTool = dynamic(
  () => import("@/components/tools/WhoisLookupTool"),
  { loading: ToolLoading }
);
const SSLCheckerTool = dynamic(
  () => import("@/components/tools/SSLCheckerTool"),
  { loading: ToolLoading }
);
const WatermarkImageTool = dynamic(
  () => import("@/components/tools/WatermarkImageTool"),
  { loading: ToolLoading }
);
const Mp4ToGifTool = dynamic(
  () => import("@/components/tools/Mp4ToGifTool"),
  { loading: ToolLoading }
);
...
const PdfToHtmlTool = dynamic(
  () => import("@/components/tools/PdfToHtmlTool"),
  { loading: ToolLoading }
);
const PdfToPptTool = dynamic(
  () => import("@/components/tools/PdfToPptTool"),
  { loading: ToolLoading }
);
const PdfFormFillerTool = dynamic(
  () => import("@/components/tools/PdfFormFillerTool"),
  { loading: ToolLoading }
);
const GenericMockTool = dynamic(
  () => import("@/components/tools/GenericMockTool"),
  { loading: ToolLoading, ssr: false },
);
const TextConversionTool = dynamic(
  () => import("@/components/tools/TextConversionTool"),
  { loading: ToolLoading, ssr: false },
);
const ExcelToJsonTool = dynamic(
  () => import("@/components/tools/ExcelToJsonTool"),
  { loading: ToolLoading, ssr: false },
);
const WordToMarkdownTool = dynamic(
  () => import("@/components/tools/WordToMarkdownTool"),
  { loading: ToolLoading, ssr: false },
);
const RSAKeyGeneratorTool = dynamic(
  () => import("@/components/tools/RSAKeyGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);

const RotateImageTool = dynamic(
  () => import("@/components/tools/RotateImageTool"),
  { loading: ToolLoading, ssr: false },
);

const JsonToTypescriptTool = dynamic(
  () => import("@/components/tools/JsonToTypescriptTool"),
  { loading: ToolLoading, ssr: false },
);
const HtmlTableGeneratorTool = dynamic(
  () => import("@/components/tools/HtmlTableGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
const CsvXmlConverterTool = dynamic(
  () => import("@/components/tools/CsvXmlConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const JsonXmlConverterTool = dynamic(
  () => import("@/components/tools/JsonXmlConverterTool"),
  { loading: ToolLoading, ssr: false },
);
const ColorPaletteGeneratorTool = dynamic(
  () => import("@/components/tools/ColorPaletteGeneratorTool"),
  { loading: ToolLoading, ssr: false },
);
...
const MarkdownToPdfTool = dynamic(
  () => import("@/components/tools/MarkdownToPdfTool"),
  { loading: ToolLoading, ssr: false },
);
const LinkShortenerTool = dynamic(
  () => import("@/components/tools/LinkShortenerTool"),
  { loading: ToolLoading, ssr: false },
);
const HtmlToPdfTool = dynamic(
  () => import("@/components/tools/HtmlToPdfTool"),
  { loading: ToolLoading, ssr: false },
);
...
const TOOL_COMPONENTS: Record<string, React.ComponentType<any>> = {
  ...
  "bmp-to-jpg": () => (
    <BulkImageConverterTool sourceFormat="BMP" targetFormat="JPG" />
  ),
  "ico-to-png": () => (
    <BulkImageConverterTool sourceFormat="ICO" targetFormat="PNG" />
  ),
  "tiff-to-png": () => (
    <BulkImageConverterTool sourceFormat="TIFF" targetFormat="PNG" />
  ),
  "heic-to-jpg": () => (
    <BulkImageConverterTool sourceFormat="HEIC" targetFormat="JPG" />
  ),
  "svg-to-png": () => (
    <BulkImageConverterTool sourceFormat="SVG" targetFormat="PNG" />
  ),
  "grayscale-image": () => <ImageFilterTool defaultFilterId="grayscale" />,
  "invert-image": () => <ImageFilterTool defaultFilterId="invert" />,
  ...
  "remove-duplicate-lines": () => (
    <TextProcessingTool mode="remove-duplicates" />
  ),
  ...
  "webp-to-jpg-converter-free": () => (
    <BulkImageConverterTool targetFormat="JPG" />
  ),
  ...
  "blur-image": () => <ImageFilterTool defaultFilterId="blur" />,
  "sharpen-image": () => <ImageFilterTool defaultFilterId="contrast" />,
  "pdf-to-pptx": () => <PdfToPptTool />,
  "pdf-to-xlsx": () => <PdfToExcelTool />,
  "pdf-to-word": PdfToWordTool,
  "pdf-page-numbering": () => <PDFAdvancedTool mode="numbering" />,
  "xml-to-json": () => <JsonXmlConverterTool mode="xml-to-json" />,
  ...
  "extract-emails-from-text": () => (
    <TextProcessingTool mode="extract-emails" />
  ),
  ...
  "add-prefix-suffix-to-lines": () => (
    <TextProcessingTool mode="add-prefix-suffix" />
  ),
  "gif-to-mp4-converter": VideoConverterTool,
  "mp4-to-gif-converter": () => <Mp4ToGifTool />,
  "compound-interest-calculator": () => (
    <FinanceCalculatorTool mode="compound-interest" />
  ),
  "simple-interest-calculator": () => (
    <FinanceCalculatorTool mode="simple-interest" />
  ),
  "tip-calculator": () => <FinanceCalculatorTool mode="tip" />,
  "discount-calculator": () => <FinanceCalculatorTool mode="discount" />,
  "keyword-density-checker": () => (
    <MiscellaneousTools mode="keyword-density" />
  ),
  ...
  "vintage-image-filter": () => <ImageFilterTool defaultFilterId="vintage" />,
  "sepia-image-filter": () => <ImageFilterTool defaultFilterId="sepia" />,
  "social-media-headline-generator": () => <SocialMediaTools mode="headline" />,
  "email-signature-generator": () => (
    <SocialMediaTools mode="email-signature" />
  ),
  ...
  "ean-barcode-generator": () => <BarcodeGeneratorTool defaultFormat="EAN13" />,
  "upc-barcode-generator": () => <BarcodeGeneratorTool defaultFormat="UPC" />,
  ...
  "extract-phone-numbers": () => (
    <TextProcessingTool mode="extract-phone-numbers" />
  ),
  ...
  "temperature-converter": () => (
    <UnitConverterTool initialCategory="temperature" />
  ),
  ...
  "digital-storage-converter": () => (
    <UnitConverterTool initialCategory="digital" />
  ),
  ...
  // New tools (204 total)
  "bcrypt-generator": () => <HashGeneratorTool algorithm="SHA-256" />, // Note: UI will show SHA-256 for now until Bcrypt added
  ...
  "roman-numeral-converter": () => <MathTool mode="roman" />,
  "binary-calculator": () => <MathTool mode="binary" />,
  "image-to-pdf-converter": JpgToPdfTool,
  "json-to-xml": () => <TextConversionTool mode="json-to-xml" />,
  "yaml-to-toml": () => <JsonYamlConverter mode="yaml-to-toml" />,
  "toml-to-json": () => <JsonYamlConverter mode="toml-to-json" />,
  ...
  "word-to-pdf": ComingSoonTool,
  "text-to-unicode": () => <TextConverterTool mode="text-to-unicode" />,
  "html-table-generator": () => (
    <TextConversionTool mode="html-table-generator" />
  ),
  ...
  "photo-enhancer": () => <ImageFilterTool defaultFilterId="contrast" />,
  ...
  // Slug mismatches fixes
  "email-signature-generator-tool": () => (
    <SocialMediaTools mode="email-signature" />
  ),
  "markdown-to-pdf-converter": MarkdownToPdfTool,
  "word-to-markdown-converter": WordToMarkdownTool,
  "excel-to-json-converter": ExcelToJsonTool,
  "csv-to-xml-converter": () => <TextConversionTool mode="csv-to-xml" />,
  "xml-to-csv-converter": () => <TextConversionTool mode="xml-to-csv" />,
  "string-length-calculator": WordCounterTool,
  "json-to-typescript-interface": () => (
    <TextConversionTool mode="json-to-typescript" />
  ),
};
