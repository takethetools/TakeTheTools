...
<<<<<<< HEAD
              <div 
                ...
                className={cn(
                  "px-8 py-5 border-b border-slate-50 flex items-center justify-between group transition-all cursor-grab active:cursor-grabbing",
                  draggedIndex === i ? "opacity-40 border-primary-500 border-dashed bg-primary-50" : "hover:bg-slate-50/50"
                )}
              >
                <div className="flex items-center gap-4">
