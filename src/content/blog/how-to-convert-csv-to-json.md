...
- In JSON, a `price` should be a **Number** (e.g., `45.99`), not a string (`"45.99"`). 
- A `status` should be a **Boolean** (`true/false`).
...
- [The Science of Data Interchange Formats](https://en.wikipedia.org/wiki/Data_exchange)
